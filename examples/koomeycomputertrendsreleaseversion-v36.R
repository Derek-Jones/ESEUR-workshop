#
# koomeycomputertrendsreleaseversion-v36.R, 19 Jun 24
# Data from:
...
plot_layout(1, 2)
par(mar=MAR_default+c(0.0, 1.7, 0, 0))
...
koomey=read.csv(paste0(ESEUR_dir, "koomeycomputertrendsreleaseversion-v36.csv.xz"), as.is=TRUE)
