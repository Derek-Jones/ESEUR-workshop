...
# Derek M. Jones
#
# TAG Stackoverflow_language Github_language


source("ESEUR_config.r")

plot_layout(1, 2)
par(mar=MAR_default+c(-0.5, 1.8, -0.5, 0))

pal_col=rainbow(3)

langpop=read.csv(paste0(ESEUR_dir, "langpop-corger-nl.csv.xz"), as.is=TRUE)
