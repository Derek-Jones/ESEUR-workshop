...
# Derek M. Jones
#
# TAG fault hardware_recall safety-critical medical
...
comp_recalls=read.csv(paste0(ESEUR_dir, "Alemzadeh-Computer_Related_Recalls.csv.xz"), as.is=TRUE)
...
# sl_mod=glm(recalls ~ fortnight, family=quasipoisson(link="identity"),
# 					 data=bined_recalls)
...
# and everything after the send of 2010
recall_subset=subset(comp_recalls, Date > as.Date("2010-12-31"))
