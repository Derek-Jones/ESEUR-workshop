#
# UserBenchmark_compare.R, 19 Jun 24
# Data from:
...
nvidia=readHTMLTable(paste0(ESEUR_dir, "UserBenchmark_Nvidia-GTX-970.htm.xz"))
...
# Two-sided test
length(which(abs(GTX_boot$t) >= abs(refl_mean_diff)))
