#
# SPEC-resid-MHz-DDR.R, 17 Jun 24
#
# Data from:
...
# Derek M. Jones
#
# TAG SPEC benchmark_memory memory_performance model_residual
...
cpu2006=read.csv(paste0(ESEUR_dir, "cpu2006-results-20140206.csv.xz"), as.is=TRUE)
...
mem2006=read.csv(paste0(ESEUR_dir, "cpu2006-memory.csv.xz"), as.is=TRUE)
