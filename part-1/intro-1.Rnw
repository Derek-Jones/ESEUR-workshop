...
* operator precedence: in R <rcode>!(x == y)</rcode>, in other languages <rcode>(!x) == y</rcode>
...
<rcode>as.character</rcode>, <rcode>as.numeric</rcode>, <rcode>as.integer</rcode>, <rcode>as.Date</rcode>, ...
...
<rcode>NA</rcode>, <rcode>is.na(x)</rcode>
...
setwd("/someplace/ESEUR-workshop/data-to-try/")  # set working directory
-----
...
<rcode>install.packages()</rcode>, <rcode>library</rcode>
...
source("../examples/data-patterns.R")
@
...
source("../examples/nasa-ada-fortran.R")
@
...
source("../examples/herraiz-projects.R")
@

<rcode>smoothScatter()</rcode> function
...
source("../examples/boxplot-10-cscw.R")
@
...
source("../examples/heatmap-hotpower.R")
@

<rcode>library("lattice")</rcode>, <rcode>levelplot()</rcode>
...
source("../examples/thereska_sipew-procspeed-memsize.R")
@
