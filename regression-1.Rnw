...
source("/usr1/rbook/examples/regression/Herraiz-BSD.R")
@

rexample[Herraiz-BSD.R]
...
source("/usr1/rbook/examples/regression/Groovy_change-prop2.R")
@

rexample[Groovy_change-prop2.R]
...
source("/usr1/rbook/examples/regression/summary_BSD-linear.R")
@
...
source("/usr1/rbook/examples/regression/federal_IT-cost_dur.R")
@

rexample[federal_IT-cost_dur.R]
...
source("/usr1/rbook/examples/regression/langpop-corger-nl.R")
@

rexample[langpop-corger-nl.R]
...
source("/usr1/rbook/examples/regression/acc-sec-experience.R")
@

rexample[acc-sec-experience.R]
...
source("/usr1/rbook/examples/regression/linux-stable.R")
@
...
source("/usr1/rbook/examples/regression/summary_linux-stable.R")
@
...
source("/usr1/rbook/examples/faults/comp-mask/comp-mask.R")
@
...
source("/usr1/rbook/examples/regression/Linux-DAYLOC.R")
@

rexample[Linux-DAYLOC.R]
...
source("/usr1/rbook/examples/regression/Linux-DAYLOC-AIC.R")
@
...
source("/usr1/rbook/examples/regression/Linux-DAYLOC-cubic.R")
@
...
source("/usr1/rbook/examples/regression/lines-per-hour.R")
@

rexample[lines-per-hour.R]
...
source("/usr1/rbook/examples/regression/lines-hour-mininf.R")
@

rexample[lines-hour-mininf.R]
...
source("/usr1/rbook/examples/regression/lines-hour-influence.R")
@

rexample[lines-hour-influence.R]
...
source("/usr1/rbook/examples/regression/Alemzadeh-Recalls.R")
@

rexample[Alemzadeh-Recalls.R]
...
source("/usr1/rbook/examples/regression/Alemzadeh-mininf.R")
@

rexample[Alemzadeh-mininf.R]
...
source("/usr1/rbook/examples/benchmark/SPEC-Mhz.R")
@
...
source("/usr1/rbook/examples/benchmark/SPEC-ind-MHz-DDR.R")
@

rexample[SPEC-ind-MHz-DDR.R]
...
source("/usr1/rbook/examples/benchmark/SPEC-resid-MHz-DDR.R")
@

rexample[SPEC-resid-MHz-DDR.R]
...
source("/usr1/rbook/examples/benchmark/SPEC-quad-MHz-DDR.R")
@

rexample[SPEC-quad-MHz-DDR.R]
...
source("/usr1/rbook/examples/regression/shared-contrib.R")
@

rexample[shared-contrib.R]
...
source("/usr1/rbook/examples/projects/simula_0a.R")
@
...
source("/usr1/rbook/examples/projects/simula_0a-Anova.R")
@
